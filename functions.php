...
function paget_customize_register( $wp_customize ) {
	$wp_customize->add_section('paget_footer', [
		'title' => __('Footer', 'paget')
	]);
	
	// Adresse
	$wp_customize->add_setting('paget_adresse', [
		'capability' => 'edit_theme_options'
	]);

	$wp_customize->add_control('paget_adresse', [
		'label' => __('Adresse', 'paget'),
		'section' => 'paget_footer'
	]);

	// Postal
	$wp_customize->add_setting('paget_postal', [
		'capability' => 'edit_theme_options'
	]);

	$wp_customize->add_control('paget_postal', [
		'label' => __('Code postal', 'paget'),
		'section' => 'paget_footer'
	]);

	// Ville
	$wp_customize->add_setting('paget_ville', [
		'capability' => 'edit_theme_options'
	]);

	$wp_customize->add_control('paget_ville', [
		'label' => __('Ville', 'paget'),
		'section' => 'paget_footer'
	]);

	// Téléphone
	$wp_customize->add_setting('paget_tel', [
		'capability' => 'edit_theme_options'
	]);

	$wp_customize->add_control('paget_tel', [
		'label' => __('Téléphone', 'paget'),
		'section' => 'paget_footer'
	]);

	// Email
	$wp_customize->add_setting('paget_mail', [
		'capability' => 'edit_theme_options'
	]);

	$wp_customize->add_control('paget_mail', [
		'label' => __('E-mail', 'paget'),
		'section' => 'paget_footer'
	]);

	// Copyright
	$wp_customize->add_setting('paget_copy', [
		'capability' => 'edit_theme_options'
	]);

	$wp_customize->add_control('paget_copy', [
		'label' => __('Copyright', 'paget'),
		'section' => 'paget_footer'
	]);
}
